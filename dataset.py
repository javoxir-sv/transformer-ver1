...
class BilingualDataset(Dataset):
    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, seq_len):
        ...
        self.sos_token = torch.tensor([tokenizer_src.token_to_id('[SOS]')], dtype=torch.int64) # list to str
    ...
    def __getitem__(self, index):
        ...
        assert decoder_input.size(0) == self.seq_len, "decoder_input != seq_len"
        assert label.size(0) == self.seq_len, "label != seq_len"
